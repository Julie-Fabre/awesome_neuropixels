...
| Feature\Implant | Juavinett et al | Luo, Bondy et al | van Daal, Aydin & Michon et al (Nat Protocol) | Aydin, van Daal et al (Neuropixels 2 paper) | Ghestem et al| Bimbard, Coen et al. - "Apollo" implant | Horan et al | Aery-Jones et al | Couto & Melin - "indie" implant | Vöröslakos, Petersen, Vöröslakos et al |
|-------------|------------|-------|---------------------|-------------------|----------|------------------|--------|------------|-------|---------|
| **Organisms** | Mouse | Rat / mouse | Mouse/rat | Mouse | Rat | Mouse/rat | Mouse/rat | Mouse | Mouse | Mouse/rat |
| **Brain areas tested** | Visual cortex, subiculum, midbrain | > 10 brain regions | > 10 brain regions | > 10 brain regions | HPC, thalamus, amygdala | > 10 brain regions | HPC, MEC, V1, Amygdala | HPC, MEC | > 6 brain regions | HPC, V1 in paper, >10 since then |
| **NPX version** | 1.0 | 1.0/2.0 | 1.0 | 2.0 | 1.0 | 1.0/2.0 | 1.0/2.0 | 1.0/2.0 | 2.0 | 1.0 |
| **# of probes/implant** | 1 | 1 | 1 (mouse) or 2 (rat) | 2 | 1 | 2 | 1 | 1 | 1 | 1 |
| **max # of probes implantable** | 1 | 8 (rat, 2.0 probes), 4 (rat, 1.0 probes), 2 (mice) |  1 (mouse) or 2 (rat) | 2 (mice), 4 (rats) | 1 | 2 | 1 | 2 | 6 | 2 (mice), 3 (rats) |
| **Weight per implant** | 1.5g | rat 1.0 implant: 2.6g, mouse: 0.7 - 1.0 g | 2.1g |  |  | 1.4g for dual 2.0 probes | 2.6g |  | 0.57g | 0.47g (machined in aluminum), 0.87g (3D print in steel) |
| **Weight per implant w/ probes + estimated cement** | 2.0g |   | 3.5g - 6.8g w/ HS |  | 13g w/ HS | 2.5g | 3.5g 2.0 w/ HS | previous: <4g dual 2.0, new: <3g dual 2.0 |  |  |
| **Implant stability & yield*** | [Fig 4](https://elifesciences.org/articles/47188#fig4) | [Fig 4 + supplements](https://elifesciences.org/articles/59716#fig4) | [Fig 11](https://www.nature.com/articles/s41596-021-00539-9#Fig11)| [Fig S2](https://www.science.org/doi/full/10.1126/science.abf4588#supplementary-materials) | [Fig 6](https://iopscience.iop.org/article/10.1088/1741-2552/ace218#jneace218f6)| [Fig 4](https://elifesciences.org/reviewed-preprints/98522#fig4) | [Fig 3](https://elifesciences.org/reviewed-preprints/98977v1#fig3) | [Ext. data fig 1e](https://www.biorxiv.org/content/10.1101/2024.07.23.604815v1.full.pdf) | | [Fig 5](https://elifesciences.org/reviewed-preprints/98977v1#fig5) |
| **Additional features** | Tested in high velocity escape behaviors | Custom positions, angles and depths for each probe | Tested in social interactions (Eco-HAB) | Tested in social interactions (Eco-HAB) | | | Tested for social interactions | Custom positions, angles and depths for each probe | Custom positions, angles and depths for each probe | Drivable |
| **Links** | [paper](https://elifesciences.org/articles/47188), [GitHub page](https://github.com/churchlandlab/ChronicNeuropixels) | [paper](https://elifesciences.org/articles/59716), [GitHub page](https://github.com/Brody-Lab/chronic_neuropixels), [mouse versions](https://github.com/Brody-Lab/mouse_npx_holders)  | [paper](https://www.nature.com/articles/s41596-021-00539-9), [GitHub page](https://github.com/nerf-common/chronic-neuropixels-protocol) | [paper](https://www.science.org/doi/full/10.1126/science.abf4588), [citation](https://zenodo.org/records/4564136), [GitHub page](https://github.com/nerf-common/chronic-neuropixels2) | [paper](https://iopscience.iop.org/article/10.1088/1741-2552/ace218), [GitHub page](https://github.com/INS-PhysioNet/npx-ghestem) | [paper](https://elifesciences.org/reviewed-preprints/98522), [GitHub page](https://github.com/Coen-Lab/chronic-neuropixels) | [paper](https://elifesciences.org/reviewed-preprints/98977v1), [protocol](https://www.protocols.io/view/protocol-for-repix-reliable-reusable-versatile-chr-4r3l2qm2ql1y/v1),| [protocol](https://open-neuroscience.com/post/chronic_recoverable_neuropixels_in_mice/) used in [paper](https://www.biorxiv.org/content/10.1101/2024.07.23.604815v1)  | [GitHub page](https://github.com/spkware/chronic_holder) | [paper](https://elifesciences.org/articles/65859), [Github link](https://buzsakilab.github.io/3d_print_designs/microdrives/microdrives/), [modified version for 2.0 probes](https://github.com/3Dneuro/R2np)|
