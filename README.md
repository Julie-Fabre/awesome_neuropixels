...
⚠️ Note that the 3D tools below use a (scaled) version of the Allen Atlas and they disagree with other standard Atlases like Franklin & Paxinos. This is because the Allen CCF atlas is not the size of the average mouse brain, and the tilt of the atlas is not levelled in bregma and lambda. To correct for these, scaling and tilt values have been approximated but they still disagree significantly with the Paxinos & Franklin Atlas. ⚠️ )
